// Example of mapping IDs to player names
const playerNames = {
  "76561198128031880": "Yuki",
  "76561198352286959": "Penumbra",
};

document.addEventListener("DOMContentLoaded", () => {
  const buttonsContainer = document.getElementById("buttonsContainer");

  // Fetch the player experience and woodcutting data concurrently
  Promise.all([
    fetch(
      ...
      ([
        ...
        for (const id in experienceData) {
          if (experienceData.hasOwnProperty(id)) {
            ...
            button.textContent = playerNames[id] || `Player (${id})`;
            button.onclick = () =>
              fetchCharacterData(
                id,
                experienceData,
    ...
    function getWeaponStats(weaponName, weaponLevel) {
      if (weaponName in characterStats) {
        ...
        stats.forEach((statCode) => {
          ...
          statsString += `<p>${statName}: +${statValue}</p><br>`;
        });
    ...
    resultDiv.innerHTML = `
        ...
        <p><strong>Weapons</strong></p>
            ...
            <div id="greatsword" class="boxed">
                ...
                <div id="text">
                  <div id="level">
                    <p><strong>Great Sword:</strong></p>
                    <p>Level: ${greatswordLevel}</p>
                  </div>
            ...
            <div id="slashers" class="boxed">
                ...
                <div id="text">
                  <div id="level">
                    <p><strong>Slashers:</strong></p>
                    <p>Level: ${slashersLevel}</p>
                  </div>
            ...
            <div id="spear" class="boxed">
                ...
                <div id="text">
                  <div id="level">
                    <p><strong>Spear:</strong></p><br>
                    <p>Level: ${spearLevel}</p>
                  </div>
